...
PLANT_DISEASES = {
    ...
    "Tomato":         ["Bacterial Spot", "Blight", "Leaf Mold", "Septoria Leaf Spot", "Viral Disease"],
    "Wheat":          ["Tan Spot"],
}
...
MODELS_DIR      = os.path.join(REPO_DIR, "checkpoints")
REPORT_DIR      = os.path.join(REPO_DIR, "data", "report")
